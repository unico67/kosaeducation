...
public class LambdaTest8 {
	public static void main(String[] args) {
		...
		System.out.println("오리니널 리스트 : " + list);
		...
		System.out.println("내림차순 : 두번째 아규먼트를 기준으로 비교하는 Comparator 객체 전달 : " + list);
		...
		System.out.println("오름차순 : 두번째 아규먼트를 기준으로 비교하는 Comparator 객체 전달 : " + list);
