...
public class MethodTest6_1 {
	...
	/*
	 * static int add(int p1, int p2) { return p1+p2; } static int add(int p1, int
	 * p2, int p3) { return p1+p2+p3; }
	 */
	/*
	 * static int add(int[] p) { int sum = 0; for(int i=0; i < p.length; i++) sum +=
	 * p[i]; return sum; }
	 */
